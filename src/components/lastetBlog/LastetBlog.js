...
const LastetBlog = () => {
  ...
  <div class="text-center">
    <h2 style={{fontWeight:"600",fontSize:"24px",lineHeight:"28.8px"}}>LASTEST BLOGS & POSTS</h2>
  ...
  <div class="col-md-3">
    <div class="card">
      ...
      <div class="card-footer">
         <button class="btn btn-outline-success p-2" style={{borderRadius:"100%",margin:"2px",float:"right",width:"17%"}} type="button" data-mdb-ripple-init data-mdb-ripple-color="dark">
