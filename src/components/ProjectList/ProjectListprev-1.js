...
const ProjectList = () => {
  ...
  useEffect(() => {
    ...
    style={{backgroundImage:`url('${require('./../../img/banner/bg_rectangle.png')}')`}}
  >
  <div className="container">
  		<center><h3 class="text-white my-2 pt-4" style={{fontWeight:"700",fontSize:"36px",lineHeight:"43.2px"}}>Find New Projects</h3></center>
      <center><h5 class="text-white pb-4" style={{fontWeight:"400",fontSize:"36px",lineHeight:"43.2px"}}>Find exciting new real estate projects and investment opportunities</h5></center>
      <div class="card p-2">
    	<div class="row p-2">
      ...
      <input
        ...
        <div>
            ...
            <button type="button" class="btn btn-light bg_makkan text-white btn-lg mx-auto"style={{backgroundColor:'#4DB749'}}>
              Search
            </button>
    		</div>
    	</div>
	...
	<div class="row">
		<div class="col-md-10">
			<div class="row">
                ...
                // console.log("post projects tests data-----============",i?.title)
                })
                .map((i, index) => {
              ...
              <h5 class="card-title" style={{fontWeight:"600",fontSize:"20px",lineHeight:"24px"}}>{i?.title}
                   <br/>
                           <p class="text-muted" style={{fontSize:"15px",fontWeight:"300",fontSize:"14px",lineHeight:"16.8px"}}>{i?.location}</p>
                </h5>    
                </Link>
				         <ul style={{listStyle:"none",paddingLeft:"0px"}} class="nav">
				                     <li style={{fontWeight:"400",fontSize:"13px",lineHeight:"15.6px"}}><i class="far fa-building text-muted"></i> <span>{i?.size} Marral</span></li>
                    <li style={{marginLeft:"10px",fontWeight:"400",fontSize:"13px",lineHeight:"15.6px"}}><span><i class="fas fa-bed text-muted"></i> {i?.beds} Beds</span></li>
                    <li style={{marginLeft:"10px",fontWeight:"400",fontSize:"13px",lineHeight:"15.6px"}}><i class="fab fa-docker text-muted"></i>  <span>{i?.baths} Baths</span></li>
				                 </ul>
				       
				        <div class="mt-3">
				                    <h6 style={{fontWeight:"600",fontSize:"16px",lineHeight:"19.2px"}}>PKR {i?.price}</h6>
				                    <a href={`tel:${i?.phone}`} class="btn bg_makkan text-white" style={{backgroundColor:'#4DB749',marginRight:"5px"}}><i class="fas fa-phone-flip"></i> Call</a>
    	<a href={`mailto:${myPost?.email}`} class="btn btn-outline-success" style={{marginRight:"5px"}}><i class="far fa-envelope"></i> Mail</a>
    	<a href={`whatsapp://send?abid=${i?.phone}`} class="btn btn-outline-success" style={{marginRight:"5px"}}><i class="fab fa-whatsapp"></i> Whatsapp</a>
				                </div>
				      </div>
				    </div>
				  </div>
			...
			<div class="">
			  <div class="row">
			    <div class="col-md-12">
			      <a href="">
			        <img src={require('./../../img/ads/Group 10099.png')} style={{width:"100%",height:"230px"}} />
			      </a>
			    </div>
			  </div>
			</div>
...
<div class="row">
		...
		<div class="col-lg-2">
			<br/><br/>
			<img src={require('./../../img/ads/Group 10098 (1).png')} class="w-100"/>
		</div>
	</div>
</div> 
      </>
